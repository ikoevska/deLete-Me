...
(function() {
    var provider = app.data.cloneExtensibilityWithGens = new Everlive({
            offlineStorage: true,
            appId: 'anv2iovri9wa2xia',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'cloneExtensibilityWithGens_access_token',
...
// START_CUSTOM_CODE_cloneExtensibilityWithGens
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_cloneExtensibilityWithGens